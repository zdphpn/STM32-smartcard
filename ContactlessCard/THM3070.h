...
#define THM_ERROR_EMVERR        0x25                                            //EMV错误
...
void THM3070_SetTYPEV(void);                                                    //设置ISO15693模式
void THM3070_SendFrame_V(uint8_t *p_buff, uint16_t len_buff);                   //发送帧15693
uint8_t	THM3070_RecvFrame_V(uint8_t *p_buff, uint16_t *len_buff);               //接收帧15693
